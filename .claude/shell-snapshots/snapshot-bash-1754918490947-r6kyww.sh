...
eval "$(echo '' | base64 -d)" > /dev/null 2>&1
# Shell Options
shopt -u autocd
...
export PATH=/root/.nvm/versions/node/v22.18.0/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
